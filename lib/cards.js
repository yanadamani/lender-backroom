...
// (id, title, description, category, driveUrl) plus a fetchFn that returns
// its data.
//
// Right now every fetchFn returns mock data and driveUrl is a placeholder.
// When the real Drive integration is wired up, each card points at exactly
// one Google Drive file/Sheet (driveUrl / driveFileId) — fetchFn reads that
// file and parses it. No per-period folder logic, no history browsing —
// each card is one file, kept up to date by whoever owns it in Drive.
//
...
export const CARD_REGISTRY = [
  {
    ...
    category: "Portfolio",
    type: "metric",
    driveUrl: null, // TODO: Google Drive/Sheet link for this dataset
    fetchFn: async () =>
      mockDelay({
  ...
  {
    id: "equity-infusion",
    title: "Equity Infusion Details",
    description: "Details of equity infusion since inception, including investor names, by tranche.",
    category: "Financials",
    type: "list",
    driveUrl: "https://docs.google.com/spreadsheets/d/1mVMkxE_h3RYlRoUczdK5CguVW7KbWis0/edit?usp=sharing",
    fetchFn: async () =>
      mockDelay({
        asOf: new Date().toISOString().slice(0, 10),
        items: [
          {
            label: "Tranche-wise Shareholder Allotment (since inception)",
            value: "Open sheet",
            url: "https://docs.google.com/spreadsheets/d/1mVMkxE_h3RYlRoUczdK5CguVW7KbWis0/edit?usp=sharing",
          },
          {
            label: "Share Transfer Details (Sep 2024)",
            value: "Open sheet",
            url: "https://docs.google.com/spreadsheets/d/1GpR4R-5hCwERMOXwPnL3Z8BbMAJJIFrW/edit?gid=321083104#gid=321083104",
          },
        ],
      }),
  },
  {
    ...
    description: "Company profile document — background, structure, and key facts.",
    category: "Company Overview",
    type: "list",
    driveUrl: "https://docs.google.com/document/d/18nRjw7S_HC23V9v6qUo2C2VAotyyrJ33/edit",
    fetchFn: async () =>
      mockDelay({
        asOf: new Date().toISOString().slice(0, 10),
        items: [
          {
            ...
            value: "Open document",
            url: "https://docs.google.com/document/d/18nRjw7S_HC23V9v6qUo2C2VAotyyrJ33/edit",
          },
        ],
      }),
  },
